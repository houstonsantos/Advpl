...
/*/{Protheus.doc} MT100GE2
    (Grava na SE2(E2_CCUSTO) o centro de custo D1_CC, somente qunado houver um único CC no documento de entrada)
    @type  Function
...
User Function MT100GE2()
    ...
    Local cCusto := Iif(AllTrim(SD1->D1_CC) == "", nLinha[AScan(aHeadSE2, {|x|AllTrim(x[2]) == "E2_CCUSTO"})], SD1->D1_CC)
