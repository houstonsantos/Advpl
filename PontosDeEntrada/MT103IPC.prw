...
/*/{Protheus.doc} MT103IPC
    (Ponto de entrada para importação de pedido em pré-nota, alimentado a descrição do produto em D1_DESCPRO)
    @type  Function
...
User Function MT103IPC()
    ...
    aCols[_nLinha][AScan(aHeader, {|x|AllTrim(x[2]) == "D1_DESCPRO"})] := _cDescr
